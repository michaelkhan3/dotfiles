# Generated by Powerlevel10k configuration wizard on 2024-02-05 at 16:14 AEDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # time                  # current time
    custom_wifi_ssid        # MK custom plugin to display the wifi network you are connected to
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  # MK function for wifi ssid prompt
    typeset -g POWERLEVEL9K_CUSTOM_WIFI_SSID="mk_wifissid"
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_SSID_FOREGROUND=204
  # typeset -g POWERLEVEL9K_WIFISSID_VISUAL_IDENTIFIER_EXPANSION='${P9K_VISUAL_IDENTIFIER}'
  ...
  mk_wifissid(){
          ...
          if [ "$airport" = "Off" ]; then
                  ...
                  [[ $speed -gt 100 ]] && color='%F{083}'
                  [[ $speed -lt 50 ]] && color='%F{black}'
